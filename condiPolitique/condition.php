...
<head>
	...
	<title>Commade Validation - Progressus</title>
...
<body>
	...
	<!-- container -->
	<div class="container col-4" style="margin: 8% auto;">
        <h1 class="page-header__title">Conditions Générales de Vente et d’Utilisation</h1>
		<div id="site-content" class="site-content">

	<div class="container clearfix ">	<article id="post-21176" class="post-21176 page type-page status-publish hentry">
	
<p><strong>ARTICLE 1 : CHAMP D’APPLICATION</strong></p>



<p>Les présentes conditions générales de vente s’appliquent à toutes les ventes conclues par le biais du site Internet https://maison-dubois.fr/.</p>



<p><strong>ARTICLE 2 : COMMANDES</strong><strong><br></strong>Les systèmes d’enregistrement automatique sont considérés comme valant preuve de la nature et du contenu de la commande. La Maison du Bois® confirme l’acceptation de sa commande au client à l’adresse e-mail que celui-ci aura communiquée. La vente sera conclue à compter de la validation par La Maison du Bois® du paiement de la commande c’est-à-dire de la date de validation du paiement pour les commandes réglées en ligne par carte bancaire ou de la date de réception du règlement par chèque. La Maison du Bois® se réserve en tout état de cause le droit de refuser ou d’annuler toute commande d’un client avec lequel existerait un différend relatif au paiement d’une commande antérieure.</p>



<p><strong>ARTICLE 3 : DISPONIBILITÉ DES ARTICLES</strong><strong><br></strong>Tant que nos offres et leurs prix sont visibles sur le site, elles sont valables. La disponibilité indiquée au moment de la consultation du site par le client reste tributaire de l’état du stock chez La Maison du Bois® et bien entendu chez les fournisseurs.</p>



<p>Pour réaliser notre vitrine et notre catalogue de vente, nous travaillons avec des bases de données, enrichie d’après les informations communiquées par nos fournisseurs. Cette base de données comportant plus d’une centaines d’articles, la totalité n’est pas stockée dans nos réserves et notre offre est alors conditionnée à la disponibilité des articles chez les fournisseurs.</p>



<p>Seule la rupture définitive d’un article chez nos fournisseurs entraîne la suppression de celui-ci de notre offre de vente. Dans les autres cas, une nouvelle commande sous un certain délai reste possible.</p>



<p>Lorsqu’il y a une indisponibilité sur un produit commandé, le client est informé par courrier électronique ou sur la facture des produits expédiés dans le cas d’une commande de plusieurs articles.</p>



<p>Date limite de livraison de la commande : lors du passage de la commande et sur l’accusé réception de commande, un délai de livraison est communiqué aux clients. Il est calculé en additionnant, le délai de disponibilité du produit le plus long, au délai d’acheminement du mode de transport sélectionné par le client.<br>Du passage de la commande, à l’expédition de celle-ci, le client à la possibilité d’annuler sa commande.</p>
...
<p><strong>Articles en précommande</strong> : des articles à paraître sont proposés sur le site https://maison-dubois.fr/ en Précommande. Cette réservation est faite avec l’indication d’une date de sortie annoncée par l’éditeur au moment de l’ouverture de la phase de réservation. Cette date de sortie peut être changée à tout moment par l’éditeur qui est seul responsable de la commercialisation de son produit.<br><br>Dans tous les cas, La Maison du Bois® s’efforce, dès la date de mise en vente définitive, d’expédier les articles aux clients ayant réservé, à hauteur du stock fourni par l’éditeur pour le jour de sortie.</p>



<p><strong>ARTICLE 4 : PRIX </strong><strong><br></strong>Les prix indiqués en euros sont réputés nets, hors frais de port. Ce prix comprend le prix des produits, les frais de manutention, d’emballage et de conservation des produits. Ils sont modifiables à tout moment sans préavis, sachant que les articles seront facturés sur la base en vigueur à l’enregistrement de la commande. Toutes les commandes sont facturées en euros et payables en euros. Les éventuels frais de douanes ou taxes locales restent à la charge du destinataire.</p>



<p><strong>ARTICLE 5 : FRAIS DE PORT</strong><strong><br></strong>Les frais de port comprennent une participation aux frais de préparation, d’emballage et d’affranchissement. Pensez à regrouper tous vos articles sur une seule commande. Nous ne pourrons pas regrouper deux commandes distinctes et les frais de port vous seront facturés pour chacune d’elle.</p>



<p><strong>ARTICLE 6 : PAIEMENT</strong><strong><br></strong>Vous disposez de plusieurs moyens de paiement offrant un maximum de garanties de sécurité. Vous pouvez régler :</p>



<p>– Par carte bancaire ou privative (carte Visa, Eurocard/Mastercard) soit directement sur le site, dans le formulaire de paiement proposé lors du processus de commande (saisie sécurisée par cryptage SSL), en renseignant le type de carte, le numéro de votre carte sans espace entre les chiffres, le numéro de contrôle (situé au dos de votre carte) ainsi que la date de validité.&nbsp;</p>



<p>– Par Paiement Paypal</p>



<p>Vous disposez de différents modes de paiement et vous pouvez même bénéficier de facilités de paiement par carte bancaire.</p>



<p>Le paiement s’effectue au choix sur les serveurs bancaires sécurisés de nos partenaires. Ceci implique qu’aucune information bancaire vous concernant ne transite via le site https://maison-dubois.fr/&nbsp;</p>



<p>Le paiement par carte bancaire est donc parfaitement sécurisé ; votre commande sera ainsi enregistrée et validée dès l’acceptation du paiement par la banque.</p>



<p><br><br><strong>ARTICLE 7 : LIVRAISON</strong><strong><br></strong>Nous vous livrons à domicile ou en point relai. Le délai de livraison comprend le temps de préparation du colis auquel s’ajoute le temps d’acheminement. La Maison du Bois® livre dans le monde entier. L’acheteur est prévenu par mails des différentes étapes du suivi de sa commande : celui de préparation et celui de livraison.</p>



<p><br>Le délai de livraison comprend le temps de préparation et la livraison assurée par notre transporteur. Le délai de livraison annoncé de 10 à 20 jours est valable dès la réception par l’acheteur du mail de la livraison de la commande. Le délai de livraison de (annoncé par le transporteur) n’engage en rien La Maison du Bois® sur un délai plus long.</p>



<p><strong>ARTICLE 8 : GARANTIE – RETOURS – REMBOURSEMENTS – RÉTRACTATION</strong><strong><br></strong>Les articles fournis par https://maison-dubois.fr/ sont neufs et garantis contre tout défaut. Ils sont identiques à ceux du commerce traditionnel et proviennent de l’ensemble des éditeurs et fournisseurs référencés.</p>



<p>S’il arrivait qu’un article soit défectueux ou non conforme, l’acheteur a 15 jours ouvrables, à compter de la réception des articles, pour demander un échange ou un remboursement. Si le délai de quinze (15) jours expire normalement un samedi, un dimanche ou un jour férié ou chômé, il est prorogé jusqu’au premier jour ouvrable suivant.</p>



<p>Le client doit renvoyer les articles neufs ou non consommés dans leur intégralité et dans leurs emballages d’origines, intacts, accompagnés de tous les accessoires éventuels, notices d’emploi et documentations&nbsp; (dans son emballage cellophane d’origine impérativement et avec la facture correspondante). Dans une telle situation, l’acheteur se doit d’envoyer la preuve du/des vice(s) à contact@maison-dubois.fr (description et photos jointes).</p>



<p>En cas d’exercice du droit de rétractation, La Maison du Bois® est tenu au remboursement des sommes versées par le client, sans frais, à l’exception des frais de retour. Le remboursement est dû dans un délai maximum de 30 jours ouvrés à compter de la date de réception du ou des colis retourné(s).</p>



<p><strong>Les frais d’expédition de retour restent alors à votre charge.</strong></p>



<p>En cas de remboursement, nous garantissons qu’il est effectué dans un délai inférieur ou égal à 30 jours suivant la date de réception du colis retourné. Aucun envoi en contre-remboursement ne sera accepté, quel qu’en soit le motif.</p>



<p><strong>ARTICLE 9 : TRANSFERT DE PROPRIÉTÉ – TRANSFERT DE RISQUES</strong></p>



<p>Le transfert de propriété des produits au profit de l’acquéreur, ne sera réalisé qu’après complet paiement du prix par ce dernier, et ce quelle que soit la date de livraison des dits produits. En revanche, le transfert des risques de perte et de détérioration des produits ne sera réalisé dès livraison et réception desdits produits par l’acquéreur.</p>



<p><strong>ARTICLE 10 : PROTECTION DE VOS DONNÉES PERSONNELLES</strong><strong><br></strong></p>



<p>La Maison du Bois® est producteur et propriétaire de tout ou partie des bases de données composant le présent site. En accédant au présent site, le client reconnaît que les données le composant sont légalement protégées, et s’interdit notamment d’extraire, réutiliser, stocker, reproduire, représenter ou conserver, directement ou indirectement, sur tout type de support, par tout moyen et sous toute forme que ce soit, tout ou partie qualitativement ou quantitativement substantielle, du contenu des bases de données figurant au site auquel il accède.</p>



<p><strong>ARTICLE 11 : RESPONSABILITÉ</strong><strong><br></strong>Les descriptifs des produits présents dans les bases de données de https://maison-dubois.fr/ ont été saisis d’après les informations communiquées par les éditeurs. La Maison du Bois® n’est pas responsable du contenu des œuvres et ne pourra voir sa responsabilité engagée à l’égard de l’acquéreur. La responsabilité de La Maison du Bois® ne peut être recherchée en cas de survenance d’un cas de force majeure (grève, inondation, incendie…).</p>



<p><br>Les produits proposés répondent à la loi du France en vigueur. La Maison du Bois® décline toute responsabilité si l’article livré ne respecte pas la législation du pays de livraison (censure, interdiction d’un titre ou d’un auteur…). La Maison du Bois® n’est pas responsable du contenu des sites sur lesquels des liens hypertextes peuvent renvoyer à partir de son propre site.</p>



<p><strong>ARTICLE 12 : DROIT APPLICABLE</strong><strong><br></strong>Toutes les clauses figurant dans les présentes conditions générales de vente, ainsi que toutes les opérations d’achat et de vente qui y sont visées, seront soumises à la loi du France.</p>



<p><strong>ARTICLE 13 : ACCEPTATION DE L’ACQUÉREUR</strong><strong><br></strong>Les présentes conditions générales de vente ainsi que les tarifs sont expressément agréés et acceptés par l’acquéreur, qui déclare et reconnaît en avoir une parfaite connaissance, et renonce, de ce fait, à se prévaloir de tout document contradictoire et, notamment, ses propres conditions générales d’achat, l’acte d’achat entraînant acceptation des présentes conditions générales de vente.</p>



<p>Les présentes conditions sont modifiables à tout moment sans préavis par La Maison du Bois – Mise à jour des conditions générales de vente le 1er janvier 2022.</p>
	</article>
